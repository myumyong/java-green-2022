    ...
    public static void main(String[] args) {
        try {
            ...
            if (dto.getCode() != 1) {
                ...
                return;// stack을 종료시키는 코드, 내가 원래 있던 큐로 돌아가는 거
            }
            ...
            for (int i = dto.getData().size() - 1; i >= 0; i--) {
                ...
                System.out.println("만들어진 날짜: " + dto.getData().get(i).getCreated());
                System.out.println("업데이트된 날짜: " + dto.getData().get(i).getUpdated());
                System.out.println("=================");
            }
